...
console.log(citySubstring.slice("York")); // Output: "York"

// 3. Sostituzione
// Sostituisci 'York' con 'Delhi'
const cityReplaced = "New Delhi";
console.log(cityReplaced.replace("New" + "Delhi")); // Output:  "New Delhi"
...
console.log(upperCaseHello.toLocaleUpperCase()); // Output: "HELLO"
